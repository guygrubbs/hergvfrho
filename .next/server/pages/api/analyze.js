"use strict";(()=>{var e={};e.id=516,e.ids=[516],e.modules={9993:e=>{e.exports=require("googleapis")},145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},2048:e=>{e.exports=require("fs")},5240:e=>{e.exports=require("https")},5315:e=>{e.exports=require("path")},2079:e=>{e.exports=import("openai")},6249:(e,n)=>{Object.defineProperty(n,"l",{enumerable:!0,get:function(){return function e(n,t){return t in n?n[t]:"then"in n&&"function"==typeof n.then?n.then(n=>e(n,t)):"function"==typeof n&&"default"===t?n:void 0}}})},526:(e,n,t)=>{t.a(e,async(e,i)=>{try{t.r(n),t.d(n,{config:()=>u,default:()=>c,routeModule:()=>m});var a=t(1802),r=t(7153),s=t(6249),o=t(5091),l=e([o]);o=(l.then?(await l)():l)[0];let c=(0,s.l)(o,"default"),u=(0,s.l)(o,"config"),m=new a.PagesAPIRouteModule({definition:{kind:r.x.PAGES_API,page:"/api/analyze",pathname:"/api/analyze",bundlePath:"",filename:""},userland:o});i()}catch(e){i(e)}})},5091:(e,n,t)=>{t.a(e,async(e,i)=>{try{t.r(n),t.d(n,{default:()=>g});var a=t(9993),r=t(2079),s=t(2048),o=t.n(s),l=t(5315),c=t.n(l);t(5240);var u=e([r]);let h=new(r=(u.then?(await u)():u)[0]).default({apiKey:"your_openai_key"}),b=()=>{let e=new a.google.auth.OAuth2("your_client_id","your_client_secret","your_redirect_uri");return e.setCredentials({refresh_token:"your_refresh_token"}),a.google.drive({version:"v3",auth:e})};async function m(e,n,t){return new Promise((i,a)=>{e.files.get({fileId:n,alt:"media"},{responseType:"stream"},(e,n)=>{if(e){a(e);return}let r=o().createWriteStream(t);n.data.on("end",()=>i(t)).on("error",e=>a(e)).pipe(r)})})}async function d(e){try{let n=new FormData;n.append("file",o().createReadStream(e));let t=await fetch("https://api.openai.com/v1/engines/whisper/transcribe",{method:"POST",headers:{Authorization:"Bearer your_openai_key"},body:n});return(await t.json()).text}catch(e){throw console.error("Error extracting text from PDF:",e),Error("Failed to extract text from PDF")}}async function p(e,n){let t=`
